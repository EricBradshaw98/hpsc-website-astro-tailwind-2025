...
### Primary Button
```astro
<button class="px-6 py-3 bg-primary text-white rounded-lg font-semibold hover:bg-primary-dark transition-colors shadow-lg">
  Primary Action
</button>
```
...
### Secondary Button
```astro
<button class="px-6 py-3 border-2 border-primary text-primary rounded-lg font-semibold hover:bg-primary hover:text-white transition-colors">
  Secondary Action
</button>
```
...
### Select Dropdown
```astro
<select class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-colors">
...
<!-- Links -->
<a class="hover:text-primary-dark transition-colors duration-200">
```
